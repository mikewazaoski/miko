...
<head>
    ...
    <style>
        /* Pink Flower Shop Theme CSS */

        :root {
            --primary-color: #ff69b4; /* Hot Pink */
            --primary-hover: #ff85c1;
            --primary-light: #ffe6f0;
            --secondary-color: #fca5a5; /* Light Coral */
            --text-color: #4b2e53; /* Deep Purple for contrast */
            --text-light: #9b5e8b; /* Soft lavender */
            --text-xlight: #d8b7dd; /* Light lavender */
            --bg-light: #fff0f5; /* Light pink background */
            --bg-white: #ffffff;
            --bg-dark: #a0522d;
            --border-color: #fbcfe8; /* Light pink borders */
            --success-color: #4BB543; /* Green for success */
            --warning-color: #ffb347; /* Soft orange-yellow for warnings */
            --danger-color: #ff4d6d; /* Bright pink/red for errors/danger */
        ...
        /* Body background and text colors for a soft floral theme */
        body {
        ...
        .avatar {
            ...
            height: 40px;
            border-radius: 50%;
            background: linear-gradient(135deg, #ff69b4, #fca5a5); /* Pink gradient */
            color: white;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .panel-header {
            background: #ffe6f0; /* Light pink header */
            padding: 1.5rem;
            border-bottom: 1px solid var(--border-color);
        }
...
<body>
    ...
    <span class="logo-text">Ekim's Flower Shop</span>
</div>
</div>
